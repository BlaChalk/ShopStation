...
!function (a) {
  ...
  var b = Array.prototype.slice,
    ...
    setWrapperHeight: function setWrapperHeight(b) {
      var c = a(b),
          d = c.parent();
      d && d.css("height", c.outerHeight());
    },
    setupChangeListeners: function setupChangeListeners(a) {
  ...
  window.addEventListener ? (window.addEventListener("scroll", i, !1), window.addEventListener("resize", j, !1)) : window.attachEvent && (window.attachEvent("onscroll", i), window.attachEvent("onresize", j)), a.fn.sticky = function (c) {
    return k[c] ? k[c].apply(this, b.call(arguments, 1)) : "object" != _typeof(c) && c ? void a.error("Method " + c + " does not exist on jQuery.sticky") : k.init.apply(this, arguments);
  }, a.fn.unstick = function (c) {
    return k[c] ? k[c].apply(this, b.call(arguments, 1)) : "object" != _typeof(c) && c ? void a.error("Method " + c + " does not exist on jQuery.sticky") : k.unstick.apply(this, arguments);
  }, a(function () {
    setTimeout(i, 0);
  });
});