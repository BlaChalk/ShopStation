...
(function () {
  ...
  $document.ready(function () {
    ...
    if ((typeof smoothScroll === "undefined" ? "undefined" : _typeof(smoothScroll)) == "object") {
      smoothScroll.init();
    }
    /*==============================================
     Menuzord init
  ...
  function initMailer() {
    ...
    $(".js-Mailer").validator().on("submit", function (e) {
      ...
      e.preventDefault();
      $.post("mailer/mailer.php", $form.serialize()).done(function (r) {
  ...
  function showMailerResponse($holder, rMessage, rType) {
    ...
    if (rType === "warning") {
      rClass = "alert-success", aClass = "alert-warning";
    }

    $holder.removeClass(rClass).addClass(aClass).text(rMessage).slideDown().delay(SPEED).slideUp();
  }
})(jQuery);